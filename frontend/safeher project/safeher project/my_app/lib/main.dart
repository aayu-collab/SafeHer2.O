...
import 'dart:html' as html; // Web storage
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text("No user found. Please signup first."), behavior: SnackBarBehavior.floating),
//       );
//       return;
//     }
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text("Incorrect email or password"), behavior: SnackBarBehavior.floating),
//       );
//       return;
//     }
...
//                     String c = contact.text.trim();
//                     String e = email.text.trim();
//                     String p = pass.text.trim();
//                     String cp = confirmPass.text.trim();

//                     if (n.isEmpty || c.isEmpty || e.isEmpty || p.isEmpty || cp.isEmpty) {
//                       ScaffoldMessenger.of(context).showSnackBar(
//                         SnackBar(
...
//                     if (!RegExp(r'^\d{10}$').hasMatch(c)) {
//                       ScaffoldMessenger.of(context).showSnackBar(
//                         SnackBar(
//                           content: Text("Enter a valid 10-digit contact number"),
//                           behavior: SnackBarBehavior.floating,
//                         ),
//                       );
//                       return;
...
//     await prefs.setString("contact", c);
//     await prefs.setString("email", e);
//     await prefs.setString("password", p);

//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text("Signup successful! Please login."), behavior: SnackBarBehavior.floating),
//     );
...
class _SignupPageState extends State<SignupPage> {
  ...
  void signup() {
    html.window.localStorage['name'] = nameController.text;
    html.window.localStorage['contact'] = contactController.text;
...
class _LoginPageState extends State<LoginPage> {
  ...
  void login() {
    String savedEmail = html.window.localStorage['email'] ?? '';
    String savedPassword = html.window.localStorage['password'] ?? '';
